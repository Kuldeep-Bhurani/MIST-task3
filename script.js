window.onload = function () {
    ...
    var start = function () {
        ...
        intervalId = setInterval(function () { generator.lifeAndDeath(); }, 100);
    ...
    document.getElementById("start_btn").addEventListener("click", start, false);
    document.getElementById("reset_btn").addEventListener("click", reset, false);
}
